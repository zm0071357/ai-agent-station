...
import static ai.agent.station.types.common.Constants.DEFAULT_MAX_STEP;
...
@Slf4j
@Service
public class StepFilter implements LogicHandler<ChatRequestEntity, DefaultExecuteLogicLinkFactory.DynamicContext, CheckRequestEntity> {
    ...
    public CheckRequestEntity apply(ChatRequestEntity chatRequestEntity, DefaultExecuteLogicLinkFactory.DynamicContext dynamicContext) throws Exception {
        ...
        int maxStep = chatRequestEntity.getMaxStep() == null ? DEFAULT_MAX_STEP : chatRequestEntity.getMaxStep();
        ...
        dynamicContext.setMaxStep(maxStep);
